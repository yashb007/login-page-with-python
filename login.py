...
class Login_System:
    def __init__(self,root):
            ...
            bg_lbl=Label(self.root,image=self.bg_icon,bd=0).pack()
    ...
    def login(self):
        ...
        elif self.uname.get()=="Yash" and self.upass.get()=="panda":
            messagebox.showinfo("Sucessfull Login",f"Welcome {self.uname.get()}")
        else:
